...
describe("Notifications Chip Filter validation for Users by ROLE -----> ", function () {
    ...
    var rolesWithPermission = chipFilterMatrix.rolesWithPermissionNotifications;
    ...
    _.forEach(rolesWithPermission, function (chipFilters, eachUser) {
        //TODO tests not  valid for new notification page
