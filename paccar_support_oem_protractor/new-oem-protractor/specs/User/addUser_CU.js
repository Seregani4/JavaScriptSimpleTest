...
describe("Customer Admin adds Customer User -----> ", () => {
    ...
    loginUserArray.forEach( (eachUser) => {
        ...
        it("I complete the add user form for a verified test user Customer Admin as: " + eachUser, () => {
            loginPage.get()
                .then(() => {
                    return  usersPage.addUserEndpoint(eachUser, customerUserRole)
                })
                .then((userid) => {
                ...
                .then(() => {
                    ...
                    usersPage.verifySelectedUserRole(customerUserRole);
        ...
        it("Check to see that the new test user has all the correct navigation links for a Customer User",  () => {
            loginPage.get();
            loginPage.login('paccar', testUserEmail, password);
            userUtility.verifyLinkVisibility(customerUserRole);
        });
