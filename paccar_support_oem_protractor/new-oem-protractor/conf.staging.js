...
exports.config = {
    ...
    afterLaunch: function afterLaunch() {
        ...
        var output = '';
        var data = [
            {path: 'reports/staging/', type: 'html'},
        ]
        data.forEach(function (data) {
            fs.readdirSync(data.path).forEach(function (file) {
                if (!(fs.lstatSync(data.path + file).isDirectory())) {
                    output = output + fs.readFileSync(data.path + file);
                }
                fs.unlinkSync(data.path + file)
            });
            fs.writeFileSync(data.path + 'ConsolidatedReport.'+data.type, output, 'utf8');
            output=''
        });
    },
    ...
    exclude: [
        'specs/User/**.js',
        'specs/Filters/chipFilterNotifications.js',
        'specs/UIValidation/notificationDateRange.js'
    ],
    suites: {
        full: 'specs/**/*.js',
    ...
    params: {
        environment: {
            ...
            entityUrl: 'http://entity-service.service.consul:58290',
        ...
        csvFilePath: {
            otaImport: '../../paccar_support_oem_protractor/csvFile/otaImport.csv',
            otaMissingVinColumn: '../../paccar_support_oem_protractor/csvFile/otaMissingVinColumn.csv',
            otaMissingStatusColumn: '../../paccar_support_oem_protractor/csvFile/otaMissingStatusColumn.csv',
        },
        adduser: {
            firstname: '000Paccar',
            lastname: '000AutoStaging',
            email: '000AddPaccarAutomation@test.com',
            newemail: 'paccareAuto@email.com',
            username: 'paccarAuto',
        ...
        testuseremails: {
            ...
            mailosaurEvgUser: 'evgautomation.qpokwwn6@mailosaur.io',
            mailosaurSpanishEvgUser: 'evgautomation-spanish.qpokwwn6@mailosaur.io',
        ...
        testuseruids: {
            ...
            testUserUid: '97519167-1038-4c15-b330-1e9fe75cd32b',
            mailosaurId: '6e696dce-9e02-4350-9ba8-580d93a87a4c',
            mailosaurKenMexId: '71226615-9dc2-4380-8fb9-3eb248546d8a'
        },
        vehicle: {
            ...
            evgvin: '1XKYDP9X0GJ492019',
            evgvin2: '1XKYDP9X1FJ467502',
            evgvin3: '1XP4DP9X0ED226102',
            evgvin4: '1XP4DP9X4ED223090',
            otavin1: '1HSJKTKR2CJ627056',
            otavin2: '1XPBDP9X9ED229765',
            expiredSubscriptionVin: '1XPBDP9X8GD306919',
            disabledVin: '1XKYDP9X4HJ144421'
        },
        gmail: {
