...
describe("Validate adding a Customer User ----- ", function () {
    ...
    loginUserArray.filter(function (eachUser) {
        it("As a" + eachUser + ", I complete the add user form for a verified test user Customer User", function () {
            ...
            usersPage.addNewUser(testUserEmail, customerUserRole, 'active', eachUser);
