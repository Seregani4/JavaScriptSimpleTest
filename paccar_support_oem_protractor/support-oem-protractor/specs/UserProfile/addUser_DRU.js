...
describe("Validate adding a  Dealer Region User ----- ", function () {
    ...
    loginUserArray.filter(function (eachUser) {
        it("As a" + eachUser + ", I complete the add user form for a verified test user  Dealer Region User", function () {
            ...
            usersPage.addNewUser(testUserEmail, dealerRegionUserRole, 'active', eachUser);
