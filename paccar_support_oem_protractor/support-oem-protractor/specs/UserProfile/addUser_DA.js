describe("Validate adding a Dealer Admin ----- ", function () {
    ...
    loginUserArray.filter(function (eachUser) {
        it("As a " + eachUser + ", I complete the add user form for a verified test user Dealer Admin", function () {
            ...
            usersPage.addNewUser(testUserEmail, dealerAdminRole, 'active', eachUser);
