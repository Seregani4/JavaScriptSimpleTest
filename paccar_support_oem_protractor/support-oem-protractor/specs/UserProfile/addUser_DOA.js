 ...
 */
describe("Validate adding a Dealer Owner Admin ----- ", function () {
    ...
    loginUserArray.filter(function (eachUser) {
        it("As a" + eachUser + ", I complete the add user form for a verified test user Dealer Owner Admin", function () {
            ...
            usersPage.addNewUser(testUserEmail, dealerOwnerAdminRole, 'active', eachUser);
