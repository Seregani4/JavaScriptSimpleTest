describe("Validate adding a Dealer User ----- ", function () {
    ...
    loginUserArray.filter(function (eachUser) {
        it("As a " + eachUser + ", I complete the add user form for a verified test user Dealer User", function () {
            ...
            usersPage.addNewUser(testUserEmail, paccarUserRole, 'active', eachUser);
