describe("Validate adding a Paccar Admin ----- ", function () {
    ...
    loginUserArray.filter(function (eachUser) {
        it("As a " + eachUser + ", I complete the add user form for a verified test user Paccar Admin", function () {
            ...
            usersPage.addNewUser(testUserEmail, paccarAdminRole, 'active', eachUser);
